...
export const metadata: Metadata = {
  title: "Driveway Paving in Bozrah CT | Northeast Paving",
  description:
    "Professional driveway-paving in Bozrah, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UdrivewayUpavingUbozrahUctPage() {
