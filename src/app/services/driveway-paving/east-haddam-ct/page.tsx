...
export const metadata: Metadata = {
  title: "Driveway Paving in East Haddam CT | Northeast Paving",
  description:
    "Professional driveway-paving in East Haddam, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UdrivewayUpavingUeastUhaddamUctPage() {
