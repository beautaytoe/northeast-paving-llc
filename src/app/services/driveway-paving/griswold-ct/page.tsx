...
export const metadata: Metadata = {
  title: "Driveway Paving in Griswold CT | Northeast Paving",
  description:
    "Professional driveway-paving in Griswold, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UdrivewayUpavingUgriswoldUctPage() {
