...
export const metadata: Metadata = {
  title: "Driveway Paving in Ledyard CT | Northeast Paving",
  description:
    "Professional driveway-paving in Ledyard, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UdrivewayUpavingUledyardUctPage() {
