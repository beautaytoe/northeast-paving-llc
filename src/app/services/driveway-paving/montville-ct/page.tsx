...
export const metadata: Metadata = {
  title: "Driveway Paving in Montville CT | Northeast Paving",
  description:
    "Professional driveway-paving in Montville, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UdrivewayUpavingUmontvilleUctPage() {
