...
export const metadata: Metadata = {
  title: "Driveway Paving in Preston CT | Northeast Paving",
  description:
    "Professional driveway-paving in Preston, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UdrivewayUpavingUprestonUctPage() {
