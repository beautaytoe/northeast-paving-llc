...
export const metadata: Metadata = {
  title: "Driveway Paving in Voluntown CT | Northeast Paving",
  description:
    "Professional driveway-paving in Voluntown, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UdrivewayUpavingUvoluntownUctPage() {
