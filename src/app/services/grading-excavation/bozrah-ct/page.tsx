...
export const metadata: Metadata = {
  title: "Grading & Excavation Bozrah CT | Northeast Paving",
  description:
    "Professional grading-excavation in Bozrah, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UgradingUexcavationUbozrahUctPage() {
