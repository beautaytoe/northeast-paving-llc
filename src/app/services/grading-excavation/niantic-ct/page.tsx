...
export const metadata: Metadata = {
  title: "Grading & Excavation Niantic CT | Northeast Paving",
  description:
    "Professional grading-excavation in Niantic, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UgradingUexcavationUnianticUctPage() {
