...
export const metadata: Metadata = {
  title: "Grading & Excavation Voluntown CT | Northeast Paving",
  description:
    "Professional grading-excavation in Voluntown, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UgradingUexcavationUvoluntownUctPage() {
