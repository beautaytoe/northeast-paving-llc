...
export const metadata: Metadata = {
  title: "Gravel & Stone Installation East Haddam CT | Northeast Paving",
  description:
    "Professional gravel-stone in East Haddam, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UgravelUstoneUeastUhaddamUctPage() {
