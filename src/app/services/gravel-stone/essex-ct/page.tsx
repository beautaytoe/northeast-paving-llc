...
export const metadata: Metadata = {
  title: "Gravel & Stone Installation Essex CT | Northeast Paving",
  description:
    "Professional gravel-stone in Essex, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UgravelUstoneUessexUctPage() {
