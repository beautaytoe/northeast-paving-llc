...
export const metadata: Metadata = {
  title: "Gravel & Stone Installation Mystic CT | Northeast Paving",
  description:
    "Professional gravel-stone in Mystic, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UgravelUstoneUmysticUctPage() {
