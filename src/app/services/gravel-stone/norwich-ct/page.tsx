...
export const metadata: Metadata = {
  title: "Gravel & Stone Installation Norwich CT | Northeast Paving",
  description:
    "Professional gravel-stone in Norwich, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UgravelUstoneUnorwichUctPage() {
