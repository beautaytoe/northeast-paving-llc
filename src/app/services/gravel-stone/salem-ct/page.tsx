...
export const metadata: Metadata = {
  title: "Gravel & Stone Installation Salem CT | Northeast Paving",
  description:
    "Professional gravel-stone in Salem, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UgravelUstoneUsalemUctPage() {
