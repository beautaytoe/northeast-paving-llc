...
export const metadata: Metadata = {
  title: "Gravel & Stone Installation Stonington CT | Northeast Paving",
  description:
    "Professional gravel-stone in Stonington, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UgravelUstoneUstoningtonUctPage() {
