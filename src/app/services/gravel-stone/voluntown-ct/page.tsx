...
export const metadata: Metadata = {
  title: "Gravel & Stone Installation Voluntown CT | Northeast Paving",
  description:
    "Professional gravel-stone in Voluntown, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UgravelUstoneUvoluntownUctPage() {
