...
export const metadata: Metadata = {
  title: "Parking Lot Paving in East Lyme CT | Northeast Paving",
  description:
    "Professional parking-lot-paving in East Lyme, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UparkingUlotUpavingUeastUlymeUctPage() {
