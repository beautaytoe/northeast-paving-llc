...
export const metadata: Metadata = {
  title: "Parking Lot Paving in Old Lyme CT | Northeast Paving",
  description:
    "Professional parking-lot-paving in Old Lyme, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UparkingUlotUpavingUoldUlymeUctPage() {
