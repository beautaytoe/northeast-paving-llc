...
export const metadata: Metadata = {
  title: "Sealcoating in East Haddam CT | Northeast Paving",
  description:
    "Professional sealcoating in East Haddam, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UsealcoatingUeastUhaddamUctPage() {
