...
export const metadata: Metadata = {
  title: "Sealcoating in East Lyme CT | Northeast Paving",
  description:
    "Professional sealcoating in East Lyme, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UsealcoatingUeastUlymeUctPage() {
