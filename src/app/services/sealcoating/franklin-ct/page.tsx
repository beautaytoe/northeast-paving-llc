...
export const metadata: Metadata = {
  title: "Sealcoating in Franklin CT | Northeast Paving",
  description:
    "Professional sealcoating in Franklin, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UsealcoatingUfranklinUctPage() {
