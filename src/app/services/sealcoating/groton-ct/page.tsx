...
export const metadata: Metadata = {
  title: "Sealcoating in Groton CT | Northeast Paving",
  description:
    "Professional sealcoating in Groton, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UsealcoatingUgrotonUctPage() {
