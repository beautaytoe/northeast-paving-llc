...
export const metadata: Metadata = {
  title: "Sealcoating in Ledyard CT | Northeast Paving",
  description:
    "Professional sealcoating in Ledyard, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UsealcoatingUledyardUctPage() {
