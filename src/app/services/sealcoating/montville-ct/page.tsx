...
export const metadata: Metadata = {
  title: "Sealcoating in Montville CT | Northeast Paving",
  description:
    "Professional sealcoating in Montville, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UsealcoatingUmontvilleUctPage() {
