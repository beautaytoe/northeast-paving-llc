...
export const metadata: Metadata = {
  title: "Sealcoating in Mystic CT | Northeast Paving",
  description:
    "Professional sealcoating in Mystic, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UsealcoatingUmysticUctPage() {
