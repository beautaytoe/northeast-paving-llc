...
export const metadata: Metadata = {
  title: "Sealcoating in North Stonington CT | Northeast Paving",
  description:
    "Professional sealcoating in North Stonington, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UsealcoatingUnorthUstoningtonUctPage() {
