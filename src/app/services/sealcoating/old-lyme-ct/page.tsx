...
export const metadata: Metadata = {
  title: "Sealcoating in Old Lyme CT | Northeast Paving",
  description:
    "Professional sealcoating in Old Lyme, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UsealcoatingUoldUlymeUctPage() {
