...
export const metadata: Metadata = {
  title: "Sealcoating in Voluntown CT | Northeast Paving",
  description:
    "Professional sealcoating in Voluntown, CT. 30+ years experience. Licensed & insured. Free estimates — (860) 447-1518.",
};

export default function UsealcoatingUvoluntownUctPage() {
